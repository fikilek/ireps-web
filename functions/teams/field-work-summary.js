// Targeted Batch rules TB-R045 (1.3.26) and Teams rules TM-R001: field work done outside batches
...
export function summarizeFieldWork({ trns = [], periods = [] } = {}) {
  ...
  const totals = { trns: trns.length, batchTrns: 0, normalTrns: 0, transactions: 0, noAccess: 0 };
